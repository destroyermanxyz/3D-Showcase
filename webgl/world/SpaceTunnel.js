...
export default class SpaceTunnel {
    ...
    setRenderTarget() {
        this.renderTarget = new THREE.RenderTarget(window.innerWidth, window.innerHeight, { samples: 3})
    }
    ...
    update() {
        ...
        this.spacePortal.material.uniforms.tDiffuse.value = this.renderTarget.texture
